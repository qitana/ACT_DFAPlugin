...
foreach ($x in $dungeon_data_en) { if ($x.38 -ne "") { $dungeon_en.Add($x.key, $x.38) } }
foreach ($x in $dungeon_data_fr) { if ($x.38 -ne "") { $dungeon_fr.Add($x.key, $x.38) } }
foreach ($x in $dungeon_data_de) { if ($x.38 -ne "") { $dungeon_de.Add($x.key, $x.38) } }
foreach ($x in $dungeon_data_ja) { if ($x.38 -ne "") { $dungeon_ja.Add($x.key, $x.38) } }
